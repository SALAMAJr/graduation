...
import 'package:furniswap/data/repository/swap/SwapRepoimpl.dart';
...
import 'package:furniswap/data/repository/order/OrderRepoImpl.dart';
...
void setupDependencies() {
  ...
  // 🟠 Address & Order & Swap Repos
  getIt.registerLazySingleton<AddressRepo>(() => AddressRepoImpl(apiService));
  getIt.registerLazySingleton<OrderRepo>(() => OrderRepoImpl(apiService));
  getIt.registerLazySingleton<SwapRepo>(() => SwapRepoImpl(apiService));
  ...
  // ✅ Order Cubit
  getIt.registerFactory<OrderCubit>(() => OrderCubit(getIt<OrderRepo>()));

  // ✅ Swap Cubit
  getIt.registerFactory<SwapCubit>(() => SwapCubit(getIt<SwapRepo>()));
}
