...
export declare class ChatController {
    ...
    create(req: Request, createChatDto: CreateChatDto): Promise<{
        status: string;
        message: string;
        data: {
            id: string;
            chatName: string;
            participants: import("../../entities/User").User[];
            messages: import("../../entities/Message").Message[];
            createdAt: Date;
        };
    }>;
    findAll(): string;
    findOne(req: Request, createChatDto: CreateChatDto): Promise<false | {
        status: string;
        message: string;
        data: {
            id: string;
    ...
    findMyChats(req: Request): Promise<{
        status: string;
        message: string;
        data?: undefined;
    } | {
